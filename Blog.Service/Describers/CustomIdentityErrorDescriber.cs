...
namespace Blog.Service.Describers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = "DuplicateEmail", Description = $"Bu email {email} adresine ait bir hesap zaten var." };
        }
        ...
        {
            return new IdentityError { Code = "DuplicateRoleName", Description = $"Bu rol {role} ismi zaten mevcut." };
        }
